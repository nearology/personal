...
I was born and raised in Iran, where I developed my passion for technology and embedded systems from an early age.

### What I do now

I'm a software engineer with a focus on embedded systems and Linux development. I work on developing embedded Linux devices and enjoy working on low-level programming challenges.

### My Work Experience

Over the past few years, I've had the opportunity to work with several companies in the technology sector:

**Company Simorgh Saha** - I worked on robotics and embedded systems projects, gaining valuable experience in hardware-software integration and embedded development.

**Company Artian** - I continued my work in embedded systems, focusing on developing efficient and reliable embedded solutions.

**Company Abrish** - I worked as a Site Reliability Engineer (SRE), where I gained experience in ensuring system reliability, monitoring, and infrastructure management.
